...
export const SERVICES: Service[] = [
  {
    ...
    intro:
      "Search is the channel that compounds. We build SEO programs around the keywords that actually drive revenue, not vanity terms. Every recommendation is grounded in real search data, a genuine competitor gap analysis, and a content engine that ships on schedule.",
    whatWeDo: [
      "Technical audits that fix crawl, indexation, speed, and Core Web Vitals at the root",
      "Keyword and intent research mapped to each stage of the buying journey",
      "On-page optimisation and internal-link architecture across the whole site",
      "A content roadmap that targets the gaps your competitors left open",
    ],
    deliverables: [
      "A prioritised technical fix list with developer-ready tickets",
      "A keyword map organised by funnel stage and target page",
    ...
    faqs: [
      { q: "How long until we see results?", a: "SEO compounds, so it rewards patience. Most engagements show measurable movement within the first quarter, with the steepest gains in months four through nine as content and authority accumulate." },
      { q: "Do you guarantee a number-one ranking?", a: "No honest agency can. What we commit to are the inputs that move rankings, and we report transparently on the outcomes, including what is and is not working." },
    ],
    keyword: "SEO agency",
  },
  {
    ...
    deliverables: [
      "A fully optimised Business Profile with a posting cadence",
      "Local landing-page templates that scale to new markets",
      "A citation audit and cleanup report",
      "Local rank tracking by city and keyword",
    ],
    outcome: "More calls, directions, and walk-ins from the people closest to you.",
    faqs: [
      { q: "We serve multiple cities. Can you cover all of them?", a: "Yes. We build a scalable local-page model, so adding a new market is repeatable rather than a rebuild every time." },
      { q: "Do reviews really matter that much?", a: "They are one of the strongest local ranking and conversion signals there is. We make earning them a system rather than an afterthought." },
    ],
  ...
  },
  {
    ...
    intro:
      "Paid media is the fastest way to test, learn, and scale demand, but only when it is run against profit. We build campaigns around your real unit economics, cut what does not work quickly, and pour budget into what does.",
    whatWeDo: [
      ...
      "Conversion tracking with offline-revenue feedback loops",
      "Budget pacing and bid strategy tuned to your target return",
    ],
    deliverables: [
      "A campaign build across your chosen platforms",
      "A creative testing roadmap with named hypotheses",
      "A transparent spend and return dashboard",
      "A weekly optimisation log: every change, with the reasoning",
    ],
    outcome: "Predictable, profitable customer acquisition you can scale or dial back at will.",
    faqs: [
      { q: "Which platforms do you run?", a: "Google Search, Performance Max, Meta, and whichever channels fit your audience. We recommend based on where your buyers actually are, not where we have a preference." },
  ...
  },
  {
    ...
    category: "Acquisition",
    tagline: "Free Google Ads budget, finally working hard.",
    ...
    intro:
      "The Google Ad Grant gives eligible non-profits a monthly budget of free search advertising. Most organisations leave the majority of it on the table. We handle eligibility, setup, and the strict compliance rules, then run it like it is your own money.",
    whatWeDo: [
      ...
      "Ongoing management so spend stays maximised rather than capped",
    ],
    deliverables: [
      "Grant application and approval support",
      "A compliant campaign build aligned to your programs",
      "Monthly spend-utilisation and conversion reporting",
      "Compliance monitoring so the Grant is never at risk",
    ],
    outcome: "More awareness, donations, and volunteers, funded by Google and run by us.",
    faqs: [
  ...
  },
  {
    ...
    intro:
      "Social is a relationship, not a billboard. We build a content engine and a posting rhythm that grows a real audience, then convert that attention into leads, applications, or sales depending on what your business needs.",
    whatWeDo: [
      ...
      "Community management so engagement stays a two-way conversation",
      "Performance review that ties content themes to outcomes",
    ],
    deliverables: [
      "A monthly content calendar and produced assets",
    ...
    faqs: [
      { q: "Which platforms should we be on?", a: "Only the ones where your audience is and where you can sustain quality. We would rather you win on two channels than spread thin across six." },
  ...
  },
  {
    ...
    intro:
      "Email is the one audience you truly own, with no algorithm in between. We build the automated flows and the ongoing campaigns that nurture subscribers, recover lost revenue, and keep customers coming back.",
    whatWeDo: [
      "Lifecycle flow design: welcome, nurture, abandonment, and win-back",
      "List segmentation so the right message reaches the right person",
      "A campaign calendar and copy that sounds like you, not a template",
      "Deliverability and list-health monitoring",
    ],
    deliverables: [
      "Core automated flows, built and live",
      "A monthly broadcast calendar with written copy",
      "A segmentation and tagging strategy",
      "Open, click, and revenue-per-email reporting",
    ],
    outcome: "A list that reliably drives revenue without extra ad spend.",
    faqs: [
      { q: "Which email platform do you work with?", a: "We work across the major platforms, including Klaviyo, Mailchimp, and HubSpot. We will recommend one or work within whatever already fits your stack." },
  ...
  },
  {
    ...
    intro:
      "Your website is the one asset every other channel points to. We design and build fast, accessible, search-ready sites on a modern stack, then wire them to convert so the traffic you earn does not leak away.",
    whatWeDo: [
      "Conversion-focused design grounded in how your buyers actually decide",
      "A modern, fast front-end build with strong Core Web Vitals",
      "On-page SEO and structured data built in from the first line",
      "A content model your team can edit without a developer",
    ],
    deliverables: [
      "A designed, responsive, accessible website",
      "A headless CMS so your team can publish independently",
  ...
  },
  {
    ...
    summary: "Brand identity, marketing collateral, and campaign creative that make you look as credible as you are.",
    intro:
      "Design is how trust gets communicated before a single word is read. We craft brand identities and the day-to-day creative, from social to ads to decks to print, that keeps you looking consistent and credible at every touchpoint.",
    whatWeDo: [
      "Brand identity: logo, palette, type, and usage guidelines",
      "Marketing collateral for digital and print",
      "Campaign and ad creative built to test and iterate",
    ...
    deliverables: [
      ...
      "Source files, which are yours to keep",
    ],
    ...
    faqs: [
      ...
      { q: "Can you work within our existing brand?", a: "Yes. We can refresh and extend an existing identity or build one from scratch, and we will recommend based on where your brand stands today." },
    ],
  ...
  },
  {
    ...
    intro:
      "The most expensive marketing is the kind aimed at the wrong people. We do the audience, competitor, and market research that grounds your strategy in evidence, so budget goes where the opportunity actually is.",
    whatWeDo: [
      "Audience and customer research: who they are, what they want, and where they look",
    ...
    deliverables: [
      "An audience and persona report",
      "A competitor and positioning analysis",
      "An opportunity map with prioritised recommendations",
    ...
    faqs: [
      { q: "Is this a standalone service?", a: "It can be. Many clients start here to set direction and then move into execution, while others fold it into a broader engagement." },
      { q: "How is this different from a quick competitor glance?", a: "We pull real search, audience, and market data over time, both historical and ongoing, rather than relying on a one-off impression." },
    ],
  ...
  },
  {
    ...
    intro:
      "Sometimes the real win is teaching rather than doing. Our workshops bring your team up to speed on the disciplines that matter, so they can own the day-to-day with confidence and bring us in for the heavy lifting when it counts.",
    whatWeDo: [
      "A tailored curriculum built around your team's gaps and goals",
    ...
    deliverables: [
      ...
      "A follow-up question-and-answer review",
    ],
    outcome: "An internal team that can run more of its own marketing, and run it well.",
    faqs: [
