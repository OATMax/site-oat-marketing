...
export const SEGMENTS: Segment[] = [
  {
    ...
    intro:
      "Early-stage marketing is a race against burn. You need traction you can show investors and customers fast, without torching the budget on channels that will not pay back. We build lean, measurable growth engines that prove what works before you scale it.",
    challenges: [
      "A limited budget that has to prove ROI quickly",
      "No established brand or organic footprint yet",
      "Pressure to show traction before the next raise",
      "A small team wearing too many hats",
    ],
    approach: [
      { title: "Start with evidence", body: "We research the market and audience first, so the first dollar goes to the highest-probability channel rather than a guess." },
  ...
  },
  {
    ...
    intro:
      "You have a working business and real revenue. Now you need marketing that scales it without the chaos. We bring senior strategy and a full execution stack so you can grow share, enter new markets, and stop leaving demand on the table.",
    challenges: [
      "Plateauing growth from channels that used to work",
      "Marketing spread thin across too many half-run channels",
      "Difficulty telling which activity actually drives revenue",
      "Competitors getting louder in your space",
    ],
    approach: [
      { title: "Consolidate and focus", body: "We audit what you are running, cut what leaks, and double down on the channels with proven return." },
      ...
      { title: "Report on revenue, not vanity", body: "Every channel ties back to pipeline and revenue, so you always know what is earning its budget." },
    ],
  ...
  },
  {
    ...
    approach: [
      { title: "Unlock free spend first", body: "We secure and fully activate the Google Ad Grant, putting a monthly budget of free Google Ads behind your mission." },
      { title: "Tell the story well", body: "Brand, content, and social that move people to give, volunteer, and share." },
      { title: "Build capability that lasts", body: "Through OAT Workshops we upskill your team, so impact keeps growing after the engagement ends." },
    ],
